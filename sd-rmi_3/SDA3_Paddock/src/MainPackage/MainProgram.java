 ...
 * Registers the paddock in the register server and waits for a connection
...
public class MainProgram {
    ...
    public static void main(String [] args){
        ...
        String nameEntryObject = SimulationParameters.PADDOCK_NAME_ENTRY;
        ...
        Paddock paddock = new Paddock(loggerInt);
        PaddockInterface paddockInt = null;
        
        try
        { paddockInt = (PaddockInterface) UnicastRemoteObject.exportObject (paddock, SimulationParameters.PADDOCK_PORT);
        }
        catch (RemoteException e)
        ...
        try
        { registerInt.bind (nameEntryObject, paddockInt);
        }
        catch (RemoteException e)
        ...
        try
        { UnicastRemoteObject.unexportObject (paddock, false);
        }
        catch (RemoteException e)
