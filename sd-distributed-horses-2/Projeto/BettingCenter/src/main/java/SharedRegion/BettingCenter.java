...
public class BettingCenter {
     ...
     */
    public synchronized void honourTheBets(ArrayList<SerializableHorse> winners){
     ...
     * @return bet amount
     */
    public synchronized int placeABet(int id, ArrayList<SerializableHorse> horses, BettingStrategy strategy, int money){
        
        logger.updateSpectatorState(id, SpectatorState.PLACING_A_BET);
        ...
        spectatorsBet += 1;
        logger.updateSpectatorBet(id, bet.getHorseToBet().getID(), bet.getMoney());
        notifyAll();
     ...
     * @return money
     */
    public synchronized int collectTheGains(int id){
        logger.updateSpectatorState(id, SpectatorState.COLLECTING_THE_GAINS);
        ...
        logger.updateSpectatorMoney(id, spectatorBetAmmount);
     ...
     */
    private synchronized ArrayList<Bet> getWinningBets(ArrayList<SerializableHorse> raceWinners){
