...
public enum BettingStrategy{
     ...
     */
    public static Bet applyStrategy(int spectatorID, ArrayList<HorseJockey> horses, BettingStrategy bettingStrategy, int money){
        
        if(horses.isEmpty())
            return null;
        
        ArrayList<HorseJockey> horsesOrdered = (ArrayList<HorseJockey>)horses.clone();
        
        horsesOrdered.sort(Comparator.comparing(horse -> horse.getAgility()));
        
        HorseJockey horseChosen;
        int moneyPercentage;
